...
#MODIFIED: Suppress local media missing warnings when Blob media is configured.
from ..extras.blob_utils import has_blob_config
...
class DatasetConverter:
    ...
    def _find_medias(self, medias: Union["MediaType", list["MediaType"], None]) -> list["MediaType"] | None:
        ...
        if self.dataset_attr.load_from in ["script", "file"]:
            #MODIFIED: Blob-backed datasets intentionally keep media off local disk.
