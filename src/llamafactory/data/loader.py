...
def _get_preprocessed_dataset(
    ...
    # Explicitly pin the output feature types to avoid pyarrow inferring `null` for the
    # multimodal columns (images/videos/audios) on batches where a dataset lacks that modality.
    # Without this, mixing image-only and video-only datasets raises:
    #   TypeError: Couldn't cast array of type list<item: string> to null
    if stage == "sft" and not data_args.packing and not data_args.streaming:
